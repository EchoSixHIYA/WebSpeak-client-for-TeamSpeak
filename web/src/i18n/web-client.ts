...
webClientTranslations.ru = {
  ...
  skinSelector: "Оформление",
  skinDay: "Дневной режим",
  skinNight: "Ночной режим",
  ...
  identityOptions: "Настройки личности устройства",
  enterVoice: "Войти в голосовое пространство",
  connectionAuthorized: "Данные подключения используются только для этой голосовой сессии",
...
webClientTranslations.ja = {
  ...
  identityOptions: "端末 ID の設定",
  enterVoice: "音声スペースに参加",
  connectionAuthorized: "接続情報は今回の音声セッションでのみ使用されます",
