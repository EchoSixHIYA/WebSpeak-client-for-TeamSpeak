...
| Версия | Изменения |
| --- | --- |
| В разработке | Добавлены русский и японский интерфейсы с отдельными шаблонами приветствия; улучшено управление звуком на компьютере, а шумоподавление перенесено во всплывающее меню микрофона. |
