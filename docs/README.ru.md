...
| Версия | Изменения |
| --- | --- |
| [v0.2.3](https://github.com/EchoSixHIYA/WebSpeak-client-for-TeamSpeak/releases/tag/v0.2.3) | Исправлены перемещение участников, проверка прав, аватары, синхронизация отключения микрофона и восстановление идентичности; обновлены функциональные скриншоты и документация для пяти языков. |
